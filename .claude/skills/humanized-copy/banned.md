...
Seeded from `../book_loom/reference/voice_template.md` Part 1 (itself collated from
...
- liminal — the genre this game is in and one of its itch.io tags. "Liminal horror"
  is what the audience searches for; a synonym would cost the reader who is looking.
